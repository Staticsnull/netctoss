    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="updatecost.do" method="post" class="main_form">
                ...
                <div class="input_info"><input type="text" class="readonly" name="costId" value="${cost.costId }" readonly /></div>
                ...
                <div class="input_info fee_type">
                    <input type="radio" name="costType" value="1" <c:if test="${cost.costType=='1' }">checked</c:if> id="monthly" onclick="feeTypeChange(1);" />
                    <label for="monthly">包月</label>
                    <input type="radio" name="costType" value="2" <c:if test="${cost.costType=='2' }">checked</c:if> id="package" onclick="feeTypeChange(2);" />
                ...
                <div class="input_info_high">
                    <textarea name="descr" class="width300 height70" value="">${cost.descr }</textarea>
                    <div class="validate_msg_short">100长度的字母、数字、汉字和下划线的组合</div>
                </div>                    
                <div class="button_info clearfix">
                    <input type="submit" value="保存" class="btn_save" />
                    <input type="button" value="取消" onclick="history.back();" class="btn_save" />
                </div>
            </form>
        </div>
        <!--主要区域结束-->
